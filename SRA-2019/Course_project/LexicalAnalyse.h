...
#define KeyId\
	...
	FST::NODE(54,\
		...
		FST::RELATION('y', 0), FST::RELATION('_', 0), FST::RELATION('z', 0), FST::RELATION('a', 1),\
FST::RELATION('b', 1),FST::RELATION('_', 1),\
...
//#define  KeyLTq\
//	{ {"", 3,\
//	FST::NODE(4,FST::RELATION('0', 0), FST::RELATION('0', 1),FST::RELATION('1', 1), FST::RELATION('1', 0)),\
//	FST::NODE(1, FST::RELATION('q', 2)), \
//	FST::NODE()}, LEX_NUMBER_2, IT::L,IT::INT}
//
//#define KeyLTy\
//{ {"", 3,\
//FST::NODE(16,FST::RELATION('0', 0), FST::RELATION('0', 1),FST::RELATION('1', 1), FST::RELATION('1', 0),FST::RELATION('2', 1), FST::RELATION('0', 2),FST::RELATION('3', 1), FST::RELATION('3', 0),FST::RELATION('4', 1), FST::RELATION('4', 0),FST::RELATION('5', 1), FST::RELATION('5', 0),FST::RELATION('6', 1), FST::RELATION('6', 0),FST::RELATION('7', 1), FST::RELATION('7', 0)),\
//FST::NODE(1, FST::RELATION('y', 2)), \
//FST::NODE()}, LEX_NUMBER_8, IT::L,IT::INT}
